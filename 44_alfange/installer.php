...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'wppack_b7f90a7bd75b7f771283_20240731164152_archive.zip';
	const ARCHIVE_SIZE		 = '65085453';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b7f90a7-31164152';
    const SECONDARY_PACKAGE_HASH = '2b46d6b-31164152';
	const VERSION			 = '1.4.4';
