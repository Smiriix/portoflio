...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20241209_domddu_cd9429ea722f811f4564_20241217130204_archive.zip';
        const ARCHIVE_SIZE       = '182054798';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'cd9429e-17130204';
        const SECONDARY_PACKAGE_HASH = 'aa0d0b8-17130204';
